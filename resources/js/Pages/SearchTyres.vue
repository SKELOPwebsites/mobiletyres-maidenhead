<template>
    <Head>
        <title>Search Tyres | Mobile Tyres Beaconsfield</title>
        <meta name="description" content="Our tyre search page allows you to easily find the perfect tyre for your vehicle by entering your tyre size.">
        <link rel="canonical" href="https://mobiletyres-beaconsfield.co.uk/search-tyres">
    </Head>
...
const tyre_sizes = usePage().props.value.tyre_sizes;
...
watch(() => form.width, (width, prevWidth) => {
    ...
    if(typeof width === "number") {
        profiles.value = [...new Set(tyre_sizes.filter((size) => size.width === width).map(size => size.profile))].sort();
    }else{
        form.reset("profile", "rim")
        profiles.value = null;
        rims.value = null;
...
watch(() => form.profile, (profile, prevProfile) => {
    ...
    if(typeof profile === "number") {
        rims.value = [...new Set(tyre_sizes.filter((size) => (size.width === form.width && size.profile === profile)).map(size => size.rim))].sort();
    }else{
        form.reset("profile", "rim")
        rims.value = null;
    }
...
function getCommonWidths() {
    return [...new Set(tyre_sizes.map(size => size.width))].filter(width => {
