<template>
    <Head>
        <title>Contact Us | Mobile Tyres Beaconsfield</title>
        <meta name="description" content="Need a quote? Have a problem? You can contact us for any inquiry!">
        <link rel="canonical" href="https://mobiletyres-beaconsfield.co.uk/contact-us">
    </Head>
    ...
    <div class="bg-black">
        <Container class="relative lg:h-[340px] md:h-[250px] h-[200px]">
            <img
                ...
                alt="Contact Mobile Tyres Beaconsfield"
            >
...
<!--                    <p class="xl:text-3xl lg:text-2xl text-xl text-gray-600 md:mb-6 mb-2">Tel: <a class="text-blue-700 hover:text-cyan-500 transition duration-300 ease-in-out" href="tel:07989606060">07989 606060</a></p>-->
                    <p class="xl:text-2xl lg:text-xl text-lg text-gray-600">Email: <a class="text-blue-700 hover:text-cyan-500 transition duration-300 ease-in-out" href="mailto:info@mobiletyres-beaconsfield.co.uk">info@mobiletyres-beaconsfield.co.uk</a></p>
                </div>
            </div>
        </div>
    </Container>
