...
<!--                                            </a>-->
                    ...
                    <li>
                        <NavLink class="border-x" href="/contact-us" title="Contact Us">Contact Us</NavLink>
                    </li>
                </ul>
            </div>
        </Container>
            ...
            <div v-show="mobileNavShow" class="md:hidden block mobile-nav w-72 fixed top-0 left-0 z-50">
                <div class="h-screen overflow-y-scroll">
                    ...
                    <div class="flex flex-col">
                        ...
                        <NavLinkMob href="/search-tyres" component="SearchTyres" title="Search Tyres" class="border-b">Search Tyres</NavLinkMob>
